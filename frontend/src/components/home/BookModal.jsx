    ...
    return (
        <div className="fixed bg-black bg-opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center" onClick={onClose}>
            <div className="w-[600px] max-w-full h-[400px bg-white rounded-xl p-4 flex flex-col relative" onClick={(event) => event.stopPropagation()} >
                ...
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dicta, eaque. Dicta eos eius delectus enim, error autem repudiandae, provident voluptas vel, eaque aliquam quae sint animi quaerat explicabo nesciunt aperiam.</p>
            </div>
        </div>
    )
}